...
32% das acomodações ficam indisponíveis durante todo o ano. Porém, mais de dois terços do conjunto de dados (40%) ficam disponíveis por mais de 100 dias no mercado.
...
```{r reg_disp_reviews_bairro, echo=FALSE, cache=FALSE, warning=FALSE,}

ggplot(subBronx, aes(x=disponibilidade_365, y=numero_de_reviews)) + 
  geom_point() +
  stat_smooth(method = "lm", se=F) +
  stat_cor(method = "spearman") + 
  labs(x = "Disponibilidade (dias)", y = "Número de reviews", title = "Número de reviews por disponibilidade no Bronx")+
  theme_minimal()
  
ggplot(subBrooklyn, aes(x=disponibilidade_365, y=numero_de_reviews)) + 
  geom_point() +
  stat_smooth(method = "lm", se=F) +
  stat_cor(method = "spearman") + 
  labs(x = "Disponibilidade (dias)", y = "Número de reviews", title = "Número de reviews por disponibilidade no Brooklyn")+
  theme_minimal()

ggplot(subManhattan, aes(x=disponibilidade_365, y=numero_de_reviews)) + 
  geom_point() +
  stat_smooth(method = "lm", se=F) +
  stat_cor(method = "spearman") + 
  labs(x = "Disponibilidade (dias)", y = "Número de reviews", title = "Número de reviews por disponibilidade em Manhattan")+
  theme_minimal()

ggplot(subQueens, aes(x=disponibilidade_365, y=numero_de_reviews)) + 
  geom_point() +
  stat_smooth(method = "lm", se=F) +
  stat_cor(method = "spearman") + 
  labs(x = "Disponibilidade (dias)", y = "Número de reviews", title = "Número de reviews por disponibilidade no Queens")+
  theme_minimal()

ggplot(subStaten, aes(x=disponibilidade_365, y=numero_de_reviews)) + 
  geom_point() +
  stat_smooth(method = "lm", se=F) +
  stat_cor(method = "spearman") + 
  labs(x = "Disponibilidade (dias)", y = "Número de reviews", title = "Número de reviews por disponibilidade em Staten Island")+
  theme_minimal()
